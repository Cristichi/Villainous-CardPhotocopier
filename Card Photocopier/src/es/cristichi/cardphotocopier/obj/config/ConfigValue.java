...
public enum ConfigValue {
	GENERATOR_VERSION("cardGeneratorVersion", "35", "The version of FailureFactory's Villainous Card Generator, as a number. "
			+ "For example, if you are running V33.2 you have to put here \"33.2\". "
			+ "This is important because the columns of the .ods file are different for version V35 onwards."),
	CARD_IMAGES("generatedCardsFolder", "C:\\Users\\crist\\Pictures\\Cartas Custom\\Villainous\\Pirate Generator\\-Exports", "Folder where all the generated images of your Villain's cards are. It must not contain other Villains' cards"),
	ODS_DOC("cardsInfoOds", "./Villainous Template.ods", "The path to the .ods file where you have your cards' info."),
	...
	VILLAIN_DECK_NAME("villainDeckName", "Villain deck", "The name of the main deck's image file to be generated. We add the \".jpg\" at the end automatically."),
	FATE_DECK_NAME("fateDeckName", "Fate deck", "The name of the Fate deck's image file to be generated. We add the \".jpg\" at the end automatically."),
	...
	FFGENERATOR("ffgeneratorSelect", "false", "If true, you will be able to use the \"ffgenerator\" settings to allow setups that use one central generator folder by copying the input folders there. Otherwise, those settings are ignored."),
	FFGENERATOR_LOCATION("ffgeneratorLocation", "C:\\Users\\crist\\Pictures\\Cartas Custom\\Villainous\\Pirate Generator", "The path to the main folder of the generator."),
	FFGENERATOR_FOLDERS("ffgeneratorFolders", "./Assets", "The path to where the folders for the current Villain are. They are \"-Exports\", \"-Images\", \"-Layout\" and \"-TextFiles\" and they have to be inside the same folder, the one you point in this setting."),
	;
