...
public enum ConfigValue {
	STEPS("steps", "generate, photocopy", "List of steps to do. They are always done in the same order. Recommended and default value: \"generate, photocopy\". If you only want to generate photocopy, use \"photocopy\"."),
