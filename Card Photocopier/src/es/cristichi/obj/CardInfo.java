...
public class CardInfo {
	...
	public String toString() {
		return String.format(
				...
				copies, name, type, desc, deck, extraDeck, cost, strength, ability.substring(0, Math.min(15, ability.length())), activateAbility, activateCost,
				topRight, bottomRight, action, credits, imageData==null?"null":"filled", row);
	}
